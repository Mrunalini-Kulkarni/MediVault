...
export default function Header({ Name, title }: HeaderProps) {
  ...
  return (
    <View style={styles.headerContainer}>
      {Name ? (
        <TouchableOpacity style={styles.profileCircle} onPress={() => router.push("/doctor/profile")}>
        ...
        <Modal transparent visible={menuVisible} animationType="fade">
          <Pressable style={styles.modalBackground} onPress={() => setMenuVisible(false)}>
            <View style={styles.menu}>
              <TouchableOpacity onPress={() => { setMenuVisible(false); router.push("/doctor/settings"); }}>
                <Text style={styles.menuItem}>Settings</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => { setMenuVisible(false); router.replace("/doctor/login"); }}>
