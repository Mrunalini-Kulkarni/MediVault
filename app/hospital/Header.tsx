...
export default function Header({ Name, title }: HeaderProps) {
  ...
  return (
    <View style={styles.headerContainer}>
      {Name ? (
        <TouchableOpacity style={styles.profileCircle} onPress={() => router.push("/hospital/settings")}>
        ...
        <Modal transparent visible={menuVisible} animationType="fade">
          <Pressable style={styles.modalBackground} onPress={() => setMenuVisible(false)}>
            <View style={styles.menu}>
              <TouchableOpacity onPress={() => { setMenuVisible(false); router.push("/hospital/settings"); }}>
                <Text style={styles.menuItem}>Settings</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => { setMenuVisible(false); router.replace("/hospital/login"); }}>
